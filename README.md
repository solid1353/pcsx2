...
This fork exposes 100 savestate slots through slot selection, menus, and
next/previous cycling. Direct per-slot save/load hotkeys deliberately remain
limited to slots 1 through 10.
